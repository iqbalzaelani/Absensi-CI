               ...
               <div class="col-xl-12 col-lg-7">
                 <div class="card shadow mb-4" style="min-height: 543px">
                   ...
                   <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                     <h6 class="m-0 font-weight-bold text-primary"Silahkan Isi Kehadiran Anda!</h6>
                   </div>
                   <!-- Card Body -->
                   <div class="card-body">
                     <?php if ($weekends == true) : ?>
                       <h1 class="text-center my-3">TERIMA KASIH ATAS KERJA KERASNYA!</h1>
                       <h5 class="card-title text-center mb-4 px-4">Manfaatkan Waktu Luang Untuk Isitirahat<b>Oke</b></h5>
                       <b>
                         <p class="text-center text-primary pt-3">Sampai Jumpa di jam kerja!</p>
                       </b>
                       <div class="row">
                     ...
                     <?php else : ?>
                       <?php if ($in == false) : ?>
                         ...
                         <div class="row mb-3">
                           <div class="col-lg-5">
                             <label for="work_shift" class="col-form-label">Shift kerja anda</label>
                             <input class="form-control" type="text" placeholder="<?= $account['shift']; ?>" value="<?= $account['shift']; ?>" name="work_shift" readonly>
                           </div>
                           <div class="col-lg-5 offset-lg-1">
                             <label for="location" class="col-form-label">Lokasi Anda</label>
                         ...
                         <div class="row mb-3">
                           <div class="col-lg-5 text-center">
                             <div class="row col">
                               <label for="image" class="col-form-label float-left">Silahkan Unggah Bukti Kehadiran</label>
                             </div>
                         ...
                         <?= form_close() ?>
                       <?php else : ?>
                         <h3 class="text-center my-3">TERIMA KASIH UNTUK KERJA KERAS HARI INI</h3>
                         <h6 class="card-title text-center mb-4 px-4">Jalan masih panjang tidak perlu terburu-buru utamakan istirahat agar dapat lebih baik di keesokan hari!!!.<br>Terima kasih atas kerja keras Anda.</h6>
                         <?php if ($disable == false) : ?>
                           <b>
                             <p class="text-center text-primary pt-3">Periska Kembali!</p>
                           </b>
                           <div class="row">
                           ...
                           <?php else : ?>
                             <b>
                               <p class="text-center text-primary pt-3">Sampai jumpa besok, Semoha hari mu menyenangkan!</p>
                             </b>
                             <div class="row">
                               <button disabled class="btn btn-danger btn-circle mx-auto" style="font-size: 35px; width: 200px; height: 200px">
                                 <i class="fas fa-fw fa-sign-out-alt fa-2x"></i>
