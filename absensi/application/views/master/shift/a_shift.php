        ...
        <div class="container-fluid">
          ...
          <form action="" method="POST" class="col-lg-5  p-0">
            <div class="card">
              <h5 class="card-header">Data Induk</h5>
              <div class="card-body">
                <h5 class="card-title">Tambahkan shift baru</h5>
                <p class="card-text">Form untuk menambahkan shift baru ke sistem</p>
                ...
                <button type="submit" class="btn btn-success btn-icon-split mt-4 float-right">
                  ...
                  <span class="text">Tambah ke system</span>
                </button>
          </form>
        </div>
        </div>
